...
import activate from './activateSlice'; // We need to register our slice here in our store as the store doesn't know that there's any slice out there. So import it and pass it inside the reducer.
