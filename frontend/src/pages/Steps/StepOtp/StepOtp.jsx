...
const StepOtp = ({ onNext }) => {
    ...
    console.log(`From setOTP: ${phone}, ${hash}`);
    ...
    async function submitfun() {
        ...
        try {
            ...
            // console.log(`from submit function ${data}`);
            console.log(data)
            ...
            <div className={styles.cardWrapper}>
                <Card title="Enter the code we just texted you" icon="lock-emoji">
                    ...
                    <div className={styles.actionButtonWrap}>
                        <Button onClick={submitfun} text="Next" />
                        {/* <button onClick={submit} className={styles.button}>
                            <img className = {styles.arrow} src="/images/arrow-forward.png" alt="arrow" />
                        </button> */}
                    </div>
                    <p className={styles.bottomParagraph}>
                    By entringing your number, you're agreeing to our Terms of service and Privacy Policy. Thanks!
                    </p>
                </Card>
            </div>
        </>
